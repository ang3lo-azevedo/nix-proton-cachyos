...
stdenv.mkDerivation {
  ...
  src = fetchurl {
    url = "https://mirror.cachyos.org/repo/x86_64_v3/cachyos-v3/proton-cachyos-1%3A${protonCachyosVersions.base}.${protonCachyosVersions.release}-x86_64_v3.pkg.tar.zst";
